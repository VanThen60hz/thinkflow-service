...
from controller.text_to_mindmap_controller import summarize_and_structure 
...
from controller.audios_to_transcrips import transcribe_multiple_audios
...
def mindmap_from_all_text():
    ...
    try:
        result_json = summarize_and_structure(full_text)
...
def summary_from_audio_to_mindmap():
    ...
    try:
        summary_result_json = summarize_and_structure(full_text)
