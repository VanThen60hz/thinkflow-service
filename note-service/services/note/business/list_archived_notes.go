...
func (biz *business) ListArchivedNotes(ctx context.Context, filter *entity.Filter, paging *core.Paging) ([]entity.Note, error) {
	notes, err := biz.noteRepo.ListArchivedNotes(ctx, filter, paging)
	if err != nil {
